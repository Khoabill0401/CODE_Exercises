...
# Vertical force at node 3 and 4 with value of -10kN
ff[6] = 10000
ff[9] = 10000
...
for iel in range(nel):
    ...
    (k) = feframe3 (el,Gl,ks,xi, leng, area, beta)
...
(es0, edi0, eci0) = beam2s(0, el, area, xi, x, y, element, ed[0], eq, 2)
(es1, edi1, eci1) = beam2s(1, el, area, xi, x, y, element, ed[1], eq, 2)
(es2, edi2, eci2) = beam2s(2, el, area, xi, x, y, element, ed[2], eq, 2)
(es3, edi3, eci3) = beam2s(3, el, area, xi, x, y, element, ed[3], eq, 2)
(es4, edi4, eci4) = beam2s(4, el, area, xi, x, y, element, ed[4], eq, 2)
(es5, edi5, eci5) = beam2s(5, el, area, xi, x, y, element, ed[5], eq, 2)

...
for iel in range(nel):
    ...
    y_j = y[element[1, iel]]
    z_j = z[element[1, iel]]
    tmp = np.array(([fsol[element[0, iel] * 6], fsol[element[0, iel] * 6 + 1], fsol[element[0, iel] * 6 + 2],
                     fsol[element[0, iel] * 6 + 3], fsol[element[0, iel] * 6 + 4], fsol[element[0, iel] * 6 + 5],
                     fsol[element[1, iel] * 6], fsol[element[1, iel] * 6 + 1], fsol[element[1, iel] * 6 + 2],
                     fsol[element[1, iel] * 6 + 3], fsol[element[1, iel] * 6 + 4], fsol[element[1, iel] * 6 + 5]]),
                   dtype=float)
    for i in range(12):
        u[iel, i] = tmp[i]

...
# PARAMETER SETTING #
#####################
n_var = 20                                          # define 10D problem domain
n_pop = 3000                                        # set population size
...
# PROBLEM SETTING #
###################
bukinn6 = Factory.set_sop("bukinn6", n_var)     # set 10D rastrigin problem
n_var = bukinn6.n_var                             # get corrected dimension
xl, xu = bukinn6.boundaries                       # get upper and lower bound

######################
# OPTIMIZATION BY DE #
######################
X = np.random.uniform(xl, xu, (n_pop, n_var))       # initialize population
F = bukinn6.F(X)                                  # evaluate fitness
...
for c_gen in range(n_gen):                          # generation loop
    ...
    F_ = bukinn6.F(X_)                            # evaluate offspring
